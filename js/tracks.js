...
function getTracksInfo() {
  ...
  var req = 'https://musicovery.com/api/V5/playlist.php?&fct=getfrommood&popularitymax=100&popularitymin=0&trackvalence=' + valence_arousal_dict[emotion][0] + '&trackarousal=' + valence_arousal_dict[emotion][1] + '&resultsnumber=' + result_number + '&format=json';
